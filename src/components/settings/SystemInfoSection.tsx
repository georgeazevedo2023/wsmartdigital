  ...
  <>
    <Card className="glass-card-hover">
      <CardHeader>
        ...
        <CardDescription>Detalhes sobre a configuração atual do sistema</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge className="bg-success/10 text-success border-success/20">Conectada</Badge>
        </div>
        <Separator />
        <div className="flex items-center justify-between">
    ...
    <Card className="glass-card-hover">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge className="bg-success/10 text-success border-success/20">Email + Senha</Badge>
        </div>
      </CardContent>
    </Card>
