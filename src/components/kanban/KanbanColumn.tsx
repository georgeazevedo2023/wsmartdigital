...
export function KanbanColumn({ column, cards, onCardClick, onAddCard, canAddCard = false, onMoveCard, hasPrev, hasNext }: KanbanColumnProps) {
  ...
  return (
    <div
      className={cn(
        'flex flex-col rounded-xl border bg-white dark:bg-muted/30 transition-colors duration-150 min-w-[280px] max-w-[280px]',
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 py-2.5 border-b border-border/60">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-base font-bold text-foreground">{column.name}</span>
